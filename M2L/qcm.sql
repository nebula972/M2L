...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 13 juil. 2022 à 23:44
...
(30, 'Lequel de ces joueurs ne fait pas parti de l equipe francaise d Overwatch ?', 0),
...
INSERT INTO `users` (`idu`, `nom`, `mdp`, `mail`, `niveau`) VALUES
(1, 'Prof', 'prof', 'ducobu@gmail', 2),
(2, 'Eleve', 'eleve', 'reien@reien', 1),
(3, 'Paul', 'paul', 'eff@fefe', 1),
(4, 'Fred', 'fred', 'fefe@fefe', 1),
(5, 'Elise', 'elise', 'zdzd@dzdz', 1),
(6, 'Lune', 'lune', 'fgg@gtgt', 2),
(7, 'yohan', '123456', 'yohanj14@gmail.com', 1),
(8, 'Cartman', '123', 'cartman@gmail.com', 1);
...
ALTER TABLE `resultats`
  ADD CONSTRAINT `resultats_ibfk_1` FOREIGN KEY (`idu`) REFERENCES `users` (`idu`);
COMMIT;
