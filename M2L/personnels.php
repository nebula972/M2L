    ...
    ?>
        ...
        <!--Présentation-->
            ...
            <ul class="presentation" id="mytab">
                ...
                <li class="mytab"><a class="active" href="personnels.php">Personnels</a></li>
            ...
            <!--Personnels-->
                <div id="personnels">
                    <div class="presentation">
                        <h1>Personnels</h1>
                        <h5>Quel est le personnel disponible ?</h5>
                        <p>
                        ...
                        <ul class="presentation">
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                        0,5 ETP sur la gestion : facturation du CROSL et du Conseil Régional, comptabilité, gestion des
                                        réservations.
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td>
                                            1 ETP d’infographiste et gestion des photocopieuses numérique.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
